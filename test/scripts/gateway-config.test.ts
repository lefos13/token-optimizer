...
test('MANAGED_ENV_KEYS covers gateway, BYOK, and local-LLM provider vars', () => {
  assert.deepEqual(cli.MANAGED_ENV_KEYS, [
    'LLM_GATEWAY_URL', 'LLM_GATEWAY_TOKEN', 'OPENROUTER_BYOK_KEY', 'OPENROUTER_BYOK_MODEL', 'LOCAL_LLM_API_URL', 'LOCAL_LLM_MODEL', 'TOKEN_OPTIMIZER_PROVIDER_MODE', 'TOKEN_OPTIMIZER_CREDENTIAL_REF', 'OPENROUTER_API_KEY', 'OPENROUTER_API_URL', 'OPENROUTER_MODEL'
  ]);
});
