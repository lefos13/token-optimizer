...
- `plugin.json` — required plugin marker/manifest (`token-optimizer` v1.12.0).
...
cp -R /Users/eevangelinos/.gemini/antigravity/scratch/local-tester-mcp/plugin/antigravity ~/.gemini/config/plugins/token-optimizer
```
