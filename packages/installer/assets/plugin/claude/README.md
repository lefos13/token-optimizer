...
- `.claude-plugin/plugin.json` — plugin manifest (`token-optimizer` v2.0.0-beta.10).
...
```bash
claude --plugin-dir /Users/eevangelinos/.gemini/antigravity/scratch/local-tester-mcp-production/plugin/claude
```
