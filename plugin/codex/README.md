...
- `.codex-plugin/plugin.json` - plugin manifest (`token-optimizer` v2.0.0-beta.10).
...
For local development without marketplace installation, load `/Users/eevangelinos/.gemini/antigravity/scratch/local-tester-mcp-production/plugin/codex`
